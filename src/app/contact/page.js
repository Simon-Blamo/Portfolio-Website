...
export default function Contact() { 
    ...
    return (
        ...
        //     </div>
        // </div>
        <div className="flex justify-center w-[65vw] h-[100vw] min-w-[380px] min-h-[546px] md:w-[450px] md:h-[80vw] md:max-h-[900px] md:rotate-[-90deg] overflow-y-hidden md:overflow-auto">
